...
//INTRO Start
        ...
        readimagefile("loading.jpg",380,270,530,320);
        readimagefile("wait.jpg",400,370,600,400);
        for(i=0; i<200; i++)
        {
        ...
        for(i=0; i<300; i++)
        {
            readimagefile("welcome1.jpg",1280-i*7,0,2560-i*5,700);
            delay(0.1);
        }
        setfillstyle(SOLID_FILL,BLACK);
        bar(0,0,1280,700);
        readimagefile("eubwel.jpg",0,0,1280,720);
        delay(3000);
        readimagefile("myintro.jpg",0,0,1280,720);
        delay(3000);
        readimagefile("mamintro.jpg",0,0,1280,720);
        delay(3000);
        setfillstyle(SOLID_FILL,BLACK);
        bar(0,0,1280,700);
        readimagefile("letstext1.jpg",0,0,1280,700);
        delay(3000);
...
//Sky
        ...
        readimagefile("sky2.jpg",0,0,1280,410);
        if(i>135)
        {
...
//Star
        if(i>=138)
        {
            readimagefile("star.jpg",200,100,210,110);
            readimagefile("star.jpg",900,100,910,110);
        }
        if(i>=140)
        {
            readimagefile("star.jpg",250,90,260,100);
            readimagefile("star.jpg",950,90,960,100);
        }
        if(i>=144)
        {
            readimagefile("star.jpg",600,20,615,35);
             readimagefile("star.jpg",870,50,880,60);
        }

        if(i>=149)
        {
            readimagefile("star.jpg",550,90,560,100);
            readimagefile("star.jpg",300,70,315,85);
            readimagefile("star.jpg",1000,70,1015,85);
        }
        if(i>=155)
        {
            readimagefile("star.jpg",20,140,30,150);
            readimagefile("star.jpg",50,70,65,85);
        }
        if(i>=159)
        {
            readimagefile("star.jpg",1110,140,1120,150);
            readimagefile("star.jpg",1150,90,1165,105);
            setcolor(WHITE);
        }
        if(i>=164)
        {
...
//Sun
        if(i<=135)
        {
            ...
            readimagefile("sun.jpg",40+(i*sunsp),40+i,70+(i*sunsp),70+i);
        }
//Moon
        if(i>138)
        {
           readimagefile("moon.jpg",400+(i*mooonsp),300-i,430+(i*mooonsp),330-i);
        }
...
//Eub Ground
        ...
        readimagefile("eub2.jpg",445,350,470,405);
        readimagefile("eub2.jpg",785,350,810,405);
        if(i<=192)
        {
            readimagefile("grass3.jpg",0,410,1280,700);
            readimagefile("pic.jpg",100,425,170,450);
        }
...
//Ground floor
        ...
        if(i<=135)
        {
            readimagefile("window.jpg",510,370,525,385);
            readimagefile("window.jpg",725,370,740,385);
            readimagefile("gate3.jpg",550,360,580,410);
            readimagefile("gate3.jpg",680,360,710,410);
        }
        if(i>135)
        {
        ...
        readimagefile("eublogo.jpg",610,360,645,395);
        setfillstyle(SOLID_FILL,BLACK);
        bar(497,340,759,358);
...
//Restaurant Night Mode
        ...
        readimagefile("restaurant.jpg",895,316,1005,329);
        readimagefile("eublunch.jpg",975,360,1005,380);
...
//Stationery Shop
        ...
        bar(130,300,360,321);
        setcolor(WHITE);
        outtextxy(190,305,"Stationery Shop");
        if(i<=135)
        {
            readimagefile("desk.jpg",245,345,330,395);
            readimagefile("maindesk.jpg",160,345,210,370);
        }
...
//Table
        ...
        bar(61,482,59,491);
        bar(65,467,63,493);
        readimagefile("tboard.jpg",28,467,67,469);
        readimagefile("tboard.jpg",28,472,67,474);
        readimagefile("tboard.jpg",28,477,67,479);
        readimagefile("tboard2.jpg",25,480,70,483);
        readimagefile("tboard.jpg",25,485,70,487);
